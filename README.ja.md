...
画像生成ツール/API が利用できる場合、Trip Canvas は計画段階で低精度のレイアウト草案とオブジェクトマップも自動生成し、ユーザーが最終画像を承認する前にページ構成を確認できるようにします。
...
- 画像生成ツール/API が利用できる場合、低精度のレイアウト草案と編集可能オブジェクトマップを自動生成します。
